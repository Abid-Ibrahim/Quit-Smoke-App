const Map langs = {
  "en": {
    ...
    "progressDescription": {
      ...
      "5": "You will breathe more easily. Your lung capacity will increase.",
      "6":
          "There will be a decrease in daily smoking crises and your chances of quitting smoking will increase 9 times.",
      "7":
          "Your lung capacity will increase by 30%. You will move and breathe more comfortably. There will be a decrease in daily smoking crises.",
      "8": "Anger, anxiety, restlessness and anger due to smoking will end.",
      "9": "Your insulin resistance will be normalized.",
      "10":
          "You will cope better with stress. Your body's airways will be cleared and your cough will decrease.",
      "11":
          "Your lungs will have experienced significant health improvements in capacity and functioning. You will notice how easily you breathe and how much less cough you cough when straining yourself, compared to when you smoke.",
      "12": "Your risk of heart attack will be the same as for a non-smoker.",
      "13": "Your risk of lung cancer will be halved.",
      "14": "Your risk of lung cancer will be the same as for a non-smoker.",
      "15": "You are the best!"
    },
    "guide": {
      "whysohard": {
...
"""
    ...
    "home": {
      ...
      "timePassed": "Time passed without smoking",
